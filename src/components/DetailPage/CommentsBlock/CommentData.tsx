...
import DecryptedCommentData from "./DecryptedCommentData";
...
const CommentData: FC<Props> = ({ comment }) => {
  if (comment?.metadata?.encryptionParams) {
    return <DecryptedCommentData encryptedPublication={comment as Publication} />
  }
  return (
