...
import { Profile, Publication, PublicationSearchResult, SearchRequestTypes } from '@/types/lens'
  ...
  return (
    <div>
      {publications?.map((publication) => (
        <VideoCard publication={publication} profile={publication.profile as Profile} />
      ))}
    </div>
  )
}
