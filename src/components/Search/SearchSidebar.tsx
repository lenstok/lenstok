...
const SearchSidebar = () => {
    ...
    const normalLink = 'flex items-center gap-3 hover:bg-primary p-3 justify-center lg:justify-start curser-pointer font-semibold text-[#96de26] rounded';
        ...
        <div className="lg:border-b-2 border-gray-200 xl:pb-4">
            <Link href={`/search?q=${query.q}&type=profiles`}>
                <div className={normalLink}>
                    <a className="text-lg hidden lg:block cursor-pointer">Profiles</a>
                </div>
            </Link>
