    ...
    return (
      ...
      {alreadyCollected ? (
       ...
       <FolderPlusIcon className="w-4 h-4 text-[#96de26] font-bold" onClick={() =>{setShowCollectModal(true)}} />
        ...
        <div className="flex items-center drop-shadow-lg  border border-[#96de26] md:border-none md:bg-emerald-700 rounded-full p-2 md:p-3 md:hover:bg-[#96de26] group relative w-max">
