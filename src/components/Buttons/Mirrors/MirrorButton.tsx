    ...
    return (
       <div className="flex gap-6">
        ...
        {alreadyMirrored ? (
         ...
         <ArrowsRightLeftIcon className="w-6 h-6 md:w-4 md:h-4 text-[#96de26]" />
          </div>
        ) : (
        <div className="flex items-center border border-gray-800 md:border-none bg-black md:bg-emerald-700 rounded-full p-2 md:p-3 md:hover:bg-[#96de26] group relative w-max">
            <ArrowsRightLeftIcon className='w-6 h-6 md:w-4 md:h-4 text-[#96de26] font-bold md:text-white' />
