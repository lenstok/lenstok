...
import type { CreateMirrorRequest, Publication } from '@/types/lens';
...
const MirrorButton: FC<Props> = ({publication}) => {
    ...
    return (
       <div className="flex gap-6">
        ...
        {isLoading ? <Spinner /> : <ArrowsRightLeftIcon onClick={createMirror} className='w-4 h-4 font-bold text-white' /> }
