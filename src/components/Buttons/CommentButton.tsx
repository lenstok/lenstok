    ...
    return (
       <div className="flex gap-6">
        ...
        {alreadyCommented ? (
          ...
          <div className="flex items-center border border-[#96de26] md:border-none md:bg-emerald-700 rounded-full p-2 md:p-3 hover:bg-[#96de26] group relative w-max">
            <ChatBubbleLeftEllipsisIcon className='w-4 h-4 text-[#96de26] font-bold md:text-white' />
            <span className="pointer-events-none absolute -bottom-7 left-7 w-max shadow px-2 py-1 text-xs text-emerald-700 opacity-0 group-hover:opacity-100"> Comment </span>
          </div>
        )}
