        ...
        <div className="flex justify-center mx-4">
            <div className="w-full max-w-[1150px]">
                <div className="flex gap-10 p-5 border-b mb-5 mt-5 border-gray-200 bg-white w-full">
                    <span
                        className={`text-xl font-semibold cursor-pointer ${suggestedaccountsClass} mt-2`}
                        onClick={() => setSelectedTab("suggestedaccounts")}
                    >
                        Users
                    </span>
                    <span
                        className={`text-xl font-semibold cursor-pointer ${categoriesClass} mt-2`}
                        onClick={() => setSelectedTab("categories")}
                    >
                        Categories
                    </span>
                    <span
                        className={`text-xl font-semibold cursor-pointer ${searchClass} mt-2`}
