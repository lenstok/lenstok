...
export const Button = forwardRef<HTMLButtonElement, Props>(function Button(
  ...
  return (
    <button
      ...
      className={clsx(
        {
          'bg-emerald-700 hover:bg-[#96de26] border text-white focus:ring-emerald-400':
            !outline && !light && variant === 'primary',
          'bg-gray-700 hover:bg-gray-600 border border-gray-600 text-white focus:ring-gray-400':
            !outline && !light && variant === 'secondary',
          'bg-green-700 hover:bg-green-400 border border-green-600 text-white focus:ring-green-400':
            !outline && !light && variant === 'success',
          'bg-yellow-700 hover:bg-yellow-400 border border-yellow-600 text-white focus:ring-yellow-400':
          ...
          'border border-emerald-700 text-emerald hover:bg-emerald-100 focus:ring-emerald-400':
            outline && !light && variant === 'primary',
        ...
        'rounded-md font-bold disabled:opacity-50 shadow-sm focus:ring-2 focus:ring-opacity-50 focus:ring-offset-1 outline-none',
        className
      )}
      disabled={loading}
      type={rest.type}
