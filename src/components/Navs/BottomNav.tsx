...
const BottomNav: React.FC = () => {
  return (
    <div>
    <nav className="fixed bottom-0 left-0 right-0 rounded-t-md bg-emerald-700 z-10 flex items-center justify-around px-4 py-3 shadow-md">
    <button className="text-white hover:text-gray-100 focus:outline-none focus:text-gray-100 border-gray-800">
      ...
      <Link href='/upload'>
       <button className="text-white hover:text-gray-100 focus:outline-none focus:text-gray-100 border-gray-800">
        <IoMdAdd className='text-xl h-10 w-12 border-2 border-white p-2 '/>{' '}
        </button>  
        </Link>
    </nav>
    </div>
